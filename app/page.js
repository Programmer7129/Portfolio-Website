                    ...
                    <main id="content" className="pt-24 lg:w-1/2 lg:py-24">
                        <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="About me">
                            ...
                            <div className="space-y-6">
                                ...
                                with deep expertise in building scalable, cloud-native AI systems. As a Software Engineering Intern, I’ve
                                architected containerized, load-balanced pipelines using RAG-based LLMs on Azure and AWS. In my UC Davis
                                research role, I led TinyML and Health-LLM initiatives—delivering a quantized ECG anomaly detector (IEEE
                                ISCAS accepted) and a personalized Health LLM via fault-tolerant, event-driven data pipelines.
                                </p>

                                <h3 className="text-xl font-semibold text-slate-200">Key Expertise &amp; Technologies</h3>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {/* Cloud & Infrastructure */}
                                <div>
                                    <h4 className="text-lg font-medium text-teal-300 mb-2">Cloud &amp; Infrastructure</h4>
                                    <ul className="list-disc list-inside space-y-1 text-slate-400">
                                    <li>AWS (EC2, S3, Lambda, ECS/EKS)</li>
                                    <li>Azure (VMs, Functions, AKS)</li>
                                    <li>GCP (Compute Engine, Cloud Functions)</li>
                                    <li>Terraform, CloudFormation</li>
                                    <li>Docker, Kubernetes, Serverless Architectures</li>
                                ...
                                <div>
                                    <h4 className="text-lg font-medium text-teal-300 mb-2">AI/ML &amp; Data Engineering</h4>
                                    <ul className="list-disc list-inside space-y-1 text-slate-400">
                                    <li>Core ML models, RAG LLMs, TinyML (edge-computing)</li>
                                    <li>PyTorch, TensorFlow, XGBoost, SHAP, LIME</li>
                                    <li>Apache NiFi, FHIR, Kafka</li>
                                    <li>GridSearchCV, Multilabel Classification</li>
                                ...
                                <div>
                                    <h4 className="text-lg font-medium text-teal-300 mb-2">Backend &amp; Microservices</h4>
                                    <ul className="list-disc list-inside space-y-1 text-slate-400">
                                    <li>C#, .NET Core, Python (Flask, Django)</li>
                                    <li>Node.js, SQL (PostgreSQL, SQL Server)</li>
                                    <li>NoSQL (MongoDB), Prisma</li>
                                    <li>Microservices, RESTful &amp; gRPC APIs</li>
                                    <li>CI/CD (GitHub Actions), Containerized Workflows</li>
                                    </ul>
                                </div>

                                {/* Frontend & Web */}
                                <div>
                                    <h4 className="text-lg font-medium text-teal-300 mb-2">Frontend &amp; Web</h4>
                                    <ul className="list-disc list-inside space-y-1 text-slate-400">
                                    <li>Next.js, React, Tailwind CSS</li>
                                    <li>HTML5/CSS3, JavaScript/TypeScript</li>
                                    <li>Responsive UI, Vercel, Render</li>
                                    </ul>
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <ul className="list-disc list-inside space-y-1 text-slate-400">
                                    <li>Git/GitHub, Docker Compose, JIRA</li>
                                    <li>VS Code, PyCharm, Eclipse, Jupyter</li>
                                    <li>CI/CD Pipelines, Agile/Scrum Practices</li>
                                    </ul>
                                </div>
                                </div>

                                <p className="text-slate-400 leading-relaxed">
                                I’m passionate about microservices, serverless architectures, and advanced data engineering to drive measurable
                                impact, and about driving AI-powered innovation in cloud environments—building robust ML pipelines, automating
                                workflows, and deploying high-availability services. Let’s connect!
                                </p>
                            </div>
                            {/* <div>
                        ...
                        <footer className="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
                            ...
                            <p className="mt-5">
                                ...
                                &mdash; view her work on{' '}
                                <a
                                href="https://github.com/bchiang7"
                                className="font-medium text-slate-400 hover:text-teal-300 focus-visible:text-teal-300"
                                target="_blank"
                                rel="noreferrer noopener"
                                aria-label="Brittany Chiang’s GitHub (opens in a new tab)"
                                >
                                GitHub
                                </a>
                                .
