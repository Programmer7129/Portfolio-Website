...
export default function Home() {
  ...
  return (
    ...
    <div class="bg-slate-900 leading-relaxed text-slate-400 antialiased selection:bg-teal-300 selection:text-teal-900">
    <div id="__next">
                ...
                <div class="lg:flex lg:justify-between lg:gap-4">
                    <header class="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
                        <div>
                            ...
                            <h2 class="mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">AI/ML Engineer; Full-Stack Developer</h2>
                            <p class="mt-4 max-w-lg leading-normal">Aspiring engineer with a passion for tech and a knack for 
                        ...
                        <ul class="ml-1 mt-8 flex items-center" aria-label="Social-Media">
                            <li class="mr-5 text-xs shrink-0">
                                <a class="block hover:text-slate-200" target="_blank" href="https://github.com/Programmer7129" aria-label="GitHub" title="GitHub">
                            ...
                            <li class="mr-5 text-xs shrink-0">
                                <a class="block hover:text-slate-200" target="_blank" href="https://www.linkedin.com/in/vedant-patel-44b30520b/" aria-label="GitHub" title="GitHub">
                                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <main id="content" class="pt-24 lg:w-1/2 lg:py-24">
                        <section id="about" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
                            <div class="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
                                <h2 class="text-sm font-bold uppercase tracking-widest text-slate-200 lg:sr-only">About Me</h2>
                            </div>
                            <div>
                                        ...
                                        <div class="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div class="z-10 sm:col-span-6">
                                                ...
                                                <p class="mt-2 text-sm leading-normal">
                                                    Achieved efficient binary classification of ECG signals with 92.8% accuracy by ensemble Random Forest Classifier (TinyML) while significantly enhancing battery life through efficient low-power algorithms. 
                                                </p>
                                                <p class="mt-2 text-sm leading-normal">
                                                ...
                                                <ul class="mt-2 flex flex-wrap">
                                                    <li class="mr-1.5 mt-2">
                                                        <div class="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Machine Learning</div>
                                                    </li>
                                                    <li class="mr-1.5 mt-2">
                                                        <div class="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Deep Learning</div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <li class="mb-12">
                                        <div class="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div class="z-10 sm:col-span-6">
                                                ...
                                                <p class="mt-2 text-sm leading-normal">
                                                    Executed comprehensive data preprocessing and transformation on inconsistent datasets, employed classification and regression techniques for training supervised learning models to achieve an impressive 98% accuracy.
                                                </p>
                                                <p class="mt-2 text-sm leading-normal">
                                    ...
                                    <li class="mb-12">
                                        <div class="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div class="z-10 sm:col-span-6">
                                                <h3 class="font-medium leading-snug text-slate-200">
                                                    <div>
                                                        <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base" href="https://www.codelabdavis.com" target="_blank">
                                                            <span class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                                            <span>Project Manager ·
                                                                <span>
                                                                    CodeLab
                                                                    <svg class="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none ml-1 translate-y-px" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                                ...
                                                <ul class="mt-2 flex flex-wrap">
                                                    ...
                                                    <li class="mr-1.5 mt-2">
                                                        <div class="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">NodeJs</div>
                                                    </li>
                                                    <li class="mr-1.5 mt-2">
                                                    ...
                                                    <li class="mr-1.5 mt-2">
                                                        <div class="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">ExpressJs</div>
                                                    </li>
                                                    <li class="mr-1.5 mt-2">
                                                        <div class="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">NextJS</div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <ol class="group/list">
                                    <li class="mb-12">
                                        <div class="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div class="z-10 sm:col-span-6">
                                                <h3 class="font-medium text-lg leading-snug text-slate-200">
                                                    <div>
                                                        <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-xl" href="https://gdscucdavis.com" target="_blank">
                                                            <span class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                    ...
                                    <li class="mb-12">
                                        <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div class="z-10 sm:order-2 sm:col-span-6">
                                                ...
                                                <p class="mt-2 text-sm leading-normal">Created a chrome extension which provides users with practice exams with a variety of questiosn including short and long answer questions, multiple-choice questions, nuemricals, etc. based on provided lecture notes from users.</p>
                                                <ul class="mt-2 flex flex-wrap" aria-label="Technologies used:">
                                                    ...
                                                    <li class="mr-1.5 mt-2">
                                                        <div class="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">ChatGPT API</div>
                                                    </li>
                                    ...
                                    <li class="mb-12">
                                        <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div class="z-10 sm:order-2 sm:col-span-6">
                                                ...
                                                <p class="mt-2 text-sm leading-normal">Personal Website for showcasing my experience, projects and my jounrey as a software developer.</p>
                                                <ul class="mt-2 flex flex-wrap" aria-label="Technologies used:">
                                                    <li class="mr-1.5 mt-2">
                                    ...
                                    <li class="mb-12">
                                        <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div class="z-10 sm:order-2 sm:col-span-6">
                                                ...
                                                <p class="mt-2 text-sm leading-normal">Developed Breast Cancer Detection machine learning models leveraging six different ML models, including Logistic Regression and Decision Tree Classifier
                                                    to accurately classify breast cancer as benign or malignant with an average accuracy rate of 98%.</p>
                                                <ul class="mt-2 flex flex-wrap" aria-label="Technologies used:">
                                                    <li class="mr-1.5 mt-2">
                        ...
                        <section id="contact" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
                            <div class="w-full max-w-lg shadow-md rounded-lg p-6 text-white">
                                <h2 class="text-2xl font-bold text-white text-center mb-6">Get in Touch</h2>
                                <form id="" action="your-email-endpoint" method="POST" class="space-y-4" onSubmit={(event) => { sendEmail(event); reset(); }}>
                                  <div class="flex space-x-4">
                                    <div class="w-1/2">
                                      <label for="firstName" class="block text-sm font-medium text-white-700">First Name</label>
                                      <input type="text" id="firstName" name="firstName" onChange={handleChange} class="mt-1 p-2 w-full border border-gray-300 rounded-md shadow-sm text-black focus:ring-indigo-500 focus:border-indigo-500" />
                                    </div>
                                    <div class="w-1/2">
                                      <label for="lastName" class="block text-sm font-medium text-white-700">Last Name</label>
                                      <input type="text" id="lastName" name="lastName" onChange={handleChange} class="mt-1 p-2 w-full border border-gray-300 rounded-md shadow-sm text-black focus:ring-indigo-500 focus:border-indigo-500" />
                                    </div>
                                  </div>
                                  <div>
                                    <label for="email" class="text-sm font-medium text-white-700">Email Address</label>
                                    <svg class="inline-block w-2 h-2 -translate-x-1/3 -translate-y-full text-red-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="8" height="8" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M13.849 4.22c-.684-1.626-3.014-1.626-3.698 0L8.397 8.387l-4.552.361c-1.775.14-2.495 2.331-1.142 3.477l3.468 2.937-1.06 4.392c-.413 1.713 1.472 3.067 2.992 2.149L12 19.35l3.897 2.354c1.52.918 3.405-.436 2.992-2.15l-1.06-4.39 3.468-2.938c1.353-1.146.633-3.336-1.142-3.477l-4.552-.36-1.754-4.17Z"/>
                                    </svg>
                                    <input required type="email" id="email" name="email" onChange={handleChange} class="mt-1 p-2 w-full border border-gray-300 rounded-md shadow-sm text-black focus:ring-indigo-500 focus:border-indigo-500" />
                                  </div>
                                  <div>
                                    <label for="message" class="block text-sm font-medium text-white-700">Message</label>
                                    <textarea id="message" name="message" rows="4" onChange={handleChange} class="mt-1 p-2 w-full border border-gray-300 rounded-md shadow-sm text-black focus:ring-indigo-500 focus:border-indigo-500"></textarea>
                                  </div>
                                  <div class="text-center">
                                    <button type="submit" class="px-4 py-2 bg-indigo-600 text-white font-semibold rounded-md shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                      Send Message
                                    </button>
                                  </div>
                                </form>
